export const SQL_QUERIES = {
  ...
  SELECT I.id, I.itemId, T.itemType, T.name, T.price, T.stat, I.rarity, I.equiped, I.quantity, I.position
  FROM Inventory AS I
...
`,
  ...
  UPDATE_ITEM_POSITION: 'UPDATE Inventory SET position = ? WHERE itemId = ? AND charId = ?',
